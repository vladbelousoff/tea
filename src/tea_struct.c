...
tea_struct_decl_t* tea_find_struct_decl(const tea_ctx_t* ctx, const char* name)
{
  ...
  {
    tea_struct_decl_t* decl = rtl_list_record(struct_entry, tea_struct_decl_t, link);
    if (!decl) {
...
bool tea_interp_impl_blk(const tea_ctx_t* ctx, const tea_node_t* node)
{
  ...
  tea_struct_decl_t* struct_declaration = tea_find_struct_decl(ctx, block_name->buf);
  if (!struct_declaration) {
    rtl_log_err(
...
tea_val_t tea_eval_new(tea_ctx_t* ctx, tea_scope_t* scp, const tea_node_t* node)
{
  ...
  const tea_struct_decl_t* struct_declr = tea_find_struct_decl(ctx, struct_name->buf);
...
tea_val_t* tea_get_field_ptr(const tea_ctx_t* ctx, const tea_scope_t* scp, const tea_node_t* node)
{
  ...
  const tea_struct_decl_t* struct_declr = tea_find_struct_decl(ctx, object->type);
  if (!struct_declr) {
    rtl_log_err(
